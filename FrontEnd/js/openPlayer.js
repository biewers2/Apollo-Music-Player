...
async function generateLibrary() {
  ...
  for (var i = 0; i < library.length; i++)(function (i) {
    ...
    var popupMenu = document.createElement("scan");
    popupMenu.id = "popupMenu";
    popupMenu.innerHTML="I'm a popup Menu!";
    popupMenu.display = "none";
    popupMenu.hidden = true;

    song.append(popupMenu);

    song.addEventListener('contextmenu', function (e) {
      e.preventDefault();
      var popupBlock = document.getElementById("myPopup");
      if (popupBlock.display == "none") {
